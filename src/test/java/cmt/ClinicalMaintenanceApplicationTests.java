...
{
Customer t=dao.findById("C103").get();
dao.delete(t);
assertThat(dao.existsById("C103")).isFalse();
}
...
assertEquals("C102", t.getCustomerId());
...
{
Customer c=dao.findById("C104").get();
...
{
Admin t=adao.findById(3).get();
adao.delete(t);
assertThat(adao.existsById(3)).isFalse();
}
