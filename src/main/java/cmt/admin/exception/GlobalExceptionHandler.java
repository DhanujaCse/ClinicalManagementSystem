...
public ResponseEntity<String> handleNullPointerException(NullPointerException emptylistd){
	
	return new ResponseEntity<String>("610,user not logged in or not available",HttpStatus.NO_CONTENT);
}
